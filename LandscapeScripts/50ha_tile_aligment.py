...
wd_path= r"\\stri-sm01\ForestLandscapes\UAVSHARE\biomass_losses_Luisa\TreeApproach\DroneImageryAligment"
...
global_orthomosaics= [file for file in os.listdir(os.path.join(wd_path, "Product_global")) if file.endswith(".tif")]
