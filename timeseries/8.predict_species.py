...
data= pd.read_csv(r"timeseries/dataset_predictions/cainito_sgbt.csv")    ##contains the sgbt features
...
merged_final.to_csv(r"timeseries/dataset_extracted/cainito.csv")
